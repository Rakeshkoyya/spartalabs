...
export const engagementModels: EngagementModel[] = [
  ...
  },
  {
    ...
    includes: [
      ...
      "Priorities you set each sprint",
    ],
  },
  {
...
export const sprintShape: SprintDay[] = [
  {
    label: "Monday, week one",
    body: "Sprint planning. You set the priorities; we say what fits and what it displaces.",
  },
  {
    label: "Through week one",
    body: "Build, with questions raised the day they come up rather than saved for a status call.",
  },
  { label: "Friday, week one", body: "Internal review and a build you can click if you want to." },
  {
    label: "Through week two",
    body: "Build continues. Mid-sprint changes are possible and we will tell you their cost before taking them.",
  },
  {
    label: "Friday, week two",
    body: "Demo on the real product, then a written note of what shipped, what did not, and why.",
  },
];
